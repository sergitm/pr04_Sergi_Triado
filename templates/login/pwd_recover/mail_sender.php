...
try {
    ...
    $mail->Mailer = "smtp";
    $mail->Port = 465;
    $mail->Username = "s.triado@sapalomera.cat"; // Posa el teu correu, Xavi
    $mail->Password = "45966571"; // Posa la teva contrasenya, Xavi 
                                //i recorda posar permetre accés d'aplicacions menys segures: https://myaccount.google.com/lesssecureapps
    $mail->SMTPSecure = PHPMailer::ENCRYPTION_SMTPS;

    //Destinataris
    $mail->setFrom('s.triado@sapalomera.cat', 'admin'); // Posa el teu correu al primer parametre
